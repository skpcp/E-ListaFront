...
public class FindByType extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_by_type);

        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        final EditText etAbsFindByType = (EditText) findViewById(R.id.etAbsenceFindByType);
        final Button btnAbsFindByType = (Button) findViewById(R.id.btnAbsenceFindByType);

        assert btnAbsFindByType!= null;
        btnAbsFindByType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final JSONArray[] jsonArray = {null};
                String url = getString(R.string.ip)+"/elista/nieobecnosci/pobierzPoTypie/"+etAbsFindByType.getText().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(FindByType.this,
