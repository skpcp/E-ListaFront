...
public class DeactivateUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getString(R.string.ip) + "/elista/uzytkownicy/pobierzPoAktywnosci/AKTYWNY";
        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(DeactivateUserActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                String url = getString(R.string.ip) + "/elista/uzytkownicy/dezaktywujPoId/" + aId;
