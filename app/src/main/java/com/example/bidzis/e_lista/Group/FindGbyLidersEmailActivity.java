...
public class FindGbyLidersEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etEnterLidersEmial = (EditText) findViewById(R.id.etEnterLidersEmial);
        ...
        btnFindGbyLidersEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                assert etEnterLidersEmial != null;
                String elo = etEnterLidersEmial.getText().toString();
                String url = getString(R.string.ip)+"/elista/grupy/pobierzGrupePoEmailuLidera/"+etEnterLidersEmial.getText().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                if (jsonArray[0] != null) {
                                    ...
                                    for (int i=0;i<len;i++){
                                        try {
                                            ...
                                            value.add(i, "Grupa: "+jsonObject.get("nazwa").toString());
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(FindGbyLidersEmailActivity.this,
