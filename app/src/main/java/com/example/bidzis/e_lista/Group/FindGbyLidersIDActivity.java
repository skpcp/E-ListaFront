    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFindGbyLidersID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                assert etEnterLidersID != null;
                String url = getString(R.string.ip)+"/elista/grupy/pobierzGrupePoLiderze/"+etEnterLidersID.getText().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(FindGbyLidersIDActivity.this,
