...
public class ShowDailyPlan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btShow = (Button) findViewById(R.id.btnShowShowDailyPlan);
        ...
        btShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                assert etID != null;
                String url = getString(R.string.ip) + "/elista/dziennikplanow/pobierzPoUzytkowniku/" + etID.getText().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final ListView listview = (ListView) findViewById(R.id.lvShowDailyPlan);
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(ShowDailyPlan.this,
