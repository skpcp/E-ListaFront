...
public class ShowAllAbsence extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_all_absence);

        final RequestQueue requestQueue = Volley.newRequestQueue(this);
        final JSONArray[] jsonArray = {null};
        String url = getString(R.string.ip)+"/elista/nieobecnosci/pobierzWszystkie";
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        if (jsonArray[0] != null) {
                            ...
                            for (int i=0;i<len;i++){
                                try {
                                    ...
                                    value.add(i,"Name:  "+jsonObject1.getString("imie") + "\n" +"Surname:  "+ jsonObject1.getString("nazwisko") + "\n" + jsonObject.getString("data") +"\n"+"Id:  "+ jsonObject.getString("id")+"\n"+"Amount:  "+jsonObject.getString("ilosc")+"\n"+"Type:  "+jsonObject.getString("typ"));
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(ShowAllAbsence.this,
