...
public class FindByUserID extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_by_user_id);

        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        final EditText etAbsUserIDFind = (EditText) findViewById(R.id.etAbsenceUserIdFind);
        final Button btnAbsFindByUserId = (Button) findViewById(R.id.btnAbsenceFindUserID);

        assert btnAbsFindByUserId != null;
        btnAbsFindByUserId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final JSONArray[] jsonArray = {null};
                String url = getString(R.string.ip)+"/elista/nieobecnosci/pobierzPoIdUzytkownika/"+etAbsUserIDFind.getText().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                if (jsonArray[0] != null) {
                                    ...
                                    for (int i=0;i<len;i++){
                                        try {
                                            ...
                                            value.add(i,jsonObject1.get("imie") +" "+ jsonObject1.getString("nazwisko")+"\n"+jsonObject.getString("typ")+"\n"+"Ilość: "+jsonObject.getString("ilosc"));
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(FindByUserID.this,
