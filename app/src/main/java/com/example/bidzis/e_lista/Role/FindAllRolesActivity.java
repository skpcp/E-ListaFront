    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFindAllRoles.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url = getString(R.string.ip)+"/elista/role/pobierzWszystkieRole";
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(FindAllRolesActivity.this,
